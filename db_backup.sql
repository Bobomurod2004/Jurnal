...
1	regular	Philology Matters	Filologiya masalalari	Проблемы филологии
2	masters	FM Masters Series	FM magistratura seriyasi	Серия магистратуры FM
3	phd	FM Doctoral Series	FM doktorantura seriyasi	FM серия докторантуры
4	special	Special Issue	Maxsus son	Специальный выпуск
\.
...
SELECT pg_catalog.setval('public.fix_issue_categories_id_seq', 4, true);
